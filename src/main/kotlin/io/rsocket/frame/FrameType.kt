...
enum class FrameType(val encodedType: Int, flags: Int = Flags.EMPTY) {
     ...
     */
    val isFragmentable: Boolean = flags.checkFlag(Flags.IS_FRAGMENTABLE)
     ...
     */
    val canHaveMetadata: Boolean = flags.checkFlag(Flags.CAN_HAVE_METADATA)
     ...
     */
    val canHaveData: Boolean = flags.checkFlag(Flags.CAN_HAVE_DATA)
